...
public class UIPlayTween : MonoBehaviour
{
	...
	void OnHover (bool isOver)
	{
		if (enabled)
		{
			...
			{
				mActivated = isOver && (trigger == AnimationOrTween.Trigger.OnHover);
				Play(isOver);
			}
		}
	}
	...
	void OnPress (bool isPressed)
	{
		if (enabled)
		{
			...
			{
				mActivated = isPressed && (trigger == AnimationOrTween.Trigger.OnPress);
				Play(isPressed);
			}
		}
	}
	...
	void OnSelect (bool isSelected)
	{
		if (enabled)
		{
			...
			{
				mActivated = isSelected && (trigger == AnimationOrTween.Trigger.OnSelect);
				Play(isSelected);
			}
		}
	}
